...
async function getSharedHighlighter({ themes, langs, preferredHighlighter = "shiki-js" }) {
  highlighter ??= createHighlighter({
    themes: [],
    langs: ["text"],
    engine: preferredHighlighter === "shiki-wasm" ? createOnigurumaEngine(import("./wasm-OZVEDJ2E.js")) : createJavaScriptRegexEngine()
  });
...
registerCustomTheme("pierre-dark", async () => {
  const m = await import("./pierre-dark-N5RLZ3JH.js");
  return {
    ...m.default ?? m,
    name: "pierre-dark"
  };
...
registerCustomTheme("pierre-light", async () => {
  const m = await import("./pierre-light-YZ4KFU3B.js");
  return {
    ...m.default ?? m,
    name: "pierre-light"
  };
...
//# sourceMappingURL=chunk-JNYNDCCB.js.map
