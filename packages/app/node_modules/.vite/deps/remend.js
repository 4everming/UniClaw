...
// ../../node_modules/.bun/remend@1.3.0/node_modules/remend/dist/index.js
...
var I = (n, r) => {
  ...
  if ($) for (var e of $(r)) gn.call(r, e) && O(n, e, r[e]);
  return n;
};
var k = (n, r) => un(n, fn(r));
var c = (n, r) => {
...
var mn = /^(\s*(?:[-*+]|\d+[.)]) +)>(=?\s*[$]?\d)/gm;
var E = (n) => !n || typeof n != "string" || !n.includes(">") ? n : n.replace(mn, (r, e, i, s) => c(n, s) ? r : `${e}\\>${i}`);
var M = /(\*\*)([^*]*\*?)$/;
var N = /(__)([^_]*?)$/;
var y = /(\*\*\*)([^*]*?)$/;
var R = /(\*)([^*]*?)$/;
...
var pn = (n, r) => {
  let e = false;
  for (let i = 0; i < r; i += 1) n[i] === "`" && n[i + 1] === "`" && n[i + 2] === "`" && (e = !e, i += 2);
  return e;
};
var X = (n, r) => {
  let e = 1;
...
var bn = (n, r, e, i) => !!(e === "\\" || n.includes("$") && h(n, r) || m(n, r) || z(n, r) || e === "_" || i === "_" || e && i && g(e) && g(i));
var Tn = (n) => {
  let r = 0, e = false, i = n.length;
  for (let s = 0; s < i; s += 1) {
    if (n[s] === "`" && s + 2 < i && n[s + 1] === "`" && n[s + 2] === "`") {
...
var zn = (n) => {
  ...
  return Xn.filter(({ handler: i, optionKey: s }) => i.name === "links" ? S(n == null ? void 0 : n.links) || S(n == null ? void 0 : n.images) : i.name === "inlineKatex" ? Fn(n == null ? void 0 : n.inlineKatex) : S(n == null ? void 0 : n[s])).map(({ handler: i, earlyReturn: s }) => i.name === "links" ? { handler: k(I({}, i), { handle: (o) => B(o, r) }), earlyReturn: r === "protocol" ? s : void 0 } : { handler: i, earlyReturn: s });
};
var vn = (n, r) => {
  var t;
  if (!n || typeof n != "string") return n;
...
export {
  $e as default,
  pn as isWithinCodeBlock,
  m as isWithinLinkOrImageUrl,
  h as isWithinMathBlock,
  g as isWordChar
};
//# sourceMappingURL=remend.js.map
