export const dict = {
  ...
  "command.skills.open": "Open skills & apps",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by UniClaw",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in UniClaw.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "UniClaw Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.opencodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.opencodeZen.visit.prefix": "Visit ",
  "provider.connect.opencodeZen.visit.link": "www.cucloud.cn",
  "provider.connect.opencodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in UniClaw.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in UniClaw.",
  ...
  "dialog.server.description": "Switch which UniClaw server this app connects to.",
  ...
  "toast.update.description": "A new version of UniClaw ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the UniClaw team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, UniClaw does not support MCP authentication yet.',
  ...
  "sidebar.help": "Help",
  "sidebar.skills": "Skills & Apps",
  "sidebar.skills.title": "Skills and Applications",
  "sidebar.skills.empty": "No skills available",
  "sidebar.skills.footer": "Skills enhance your AI assistant with specialized capabilities",
  "sidebar.automation": "Automation",
  "sidebar.threads": "Threads",
  "sidebar.workspaces.enable": "Enable workspaces",
  "sidebar.workspaces.disable": "Disable workspaces",
  "sidebar.gettingStarted.title": "Getting started",
  "sidebar.gettingStarted.line1": "UniClaw includes free models so you can start immediately.",
  ...
  "app.name.desktop": "UniClaw Desktop",
  ...
  "settings.desktop.wsl.description": "Run the UniClaw server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for UniClaw",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how UniClaw looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether UniClaw follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how UniClaw is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when UniClaw launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of UniClaw.",
