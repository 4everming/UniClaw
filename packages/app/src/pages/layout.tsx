...
export default function Layout(props: ParentProps) {
  ...
  const side = createMemo(() => Math.max(layout.sidebar.width(), 280))
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      skillsKeybind={() => command.keybind("skills.open")}
      onOpenSkills={openSkills}
      settingsLabel={() => language.t("sidebar.settings")}
      settingsKeybind={() => command.keybind("settings.open")}
      onOpenSettings={openSettings}
      helpLabel={() => language.t("sidebar.help")}
      onOpenHelp={() => platform.openLink("https://www.cucloud.cn/")}
      renderPanel={() => null}
      ...
      automationLabel={() => language.t("sidebar.automation") ?? "Automation"}
      threadsLabel={() => language.t("sidebar.threads") ?? "Threads"}
    />
  )
          ...
          <div class="size-full relative overflow-x-hidden">
            <nav
              ...
              classList={{
                ...
                "z-10": true,
                "border-r border-border-weaker-base": layout.sidebar.opened(),
              }}
              style={{ width: layout.sidebar.opened() ? `${side()}px` : "0px" }}
              ref={(el) => {
                setState("nav", el)
              }}
            >
            ...
            <Show when={layout.sidebar.opened()}>
              ...
              >
                <ResizeHandle
                  ...
                  min={280}
                  max={typeof window === "undefined" ? 1000 : window.innerWidth * 0.4}
                  onResize={(w) => {
