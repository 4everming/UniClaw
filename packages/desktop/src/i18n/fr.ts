export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'UniClaw",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'UniClaw a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.cli.installed.message":
    "CLI installée dans {{path}}\n\nRedémarrez votre terminal pour utiliser la commande 'uniclaw'.",
  ...
  "desktop.menu.help.documentation": "Documentation d'UniClaw",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI UniClaw est manquant. Essayez de réinstaller l'application de bureau.",
