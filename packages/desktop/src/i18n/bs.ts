export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju UniClaw-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} UniClaw-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.cli.installed.message":
    "CLI je instaliran u {{path}}\n\nRestartuj terminal da bi koristio komandu 'uniclaw'.",
  ...
  "desktop.menu.help.documentation": "UniClaw Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka UniClaw CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
