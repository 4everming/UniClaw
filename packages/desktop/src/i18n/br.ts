export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do UniClaw",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do UniClaw foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do UniClaw",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do UniClaw está ausente. Tente reinstalar o aplicativo de desktop.",
