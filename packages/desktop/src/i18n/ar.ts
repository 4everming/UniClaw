export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من UniClaw",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من UniClaw، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق UniClaw",
  ...
  "desktop.cli.error.sidecarMissing": "ملف UniClaw CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
