export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af UniClaw",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af UniClaw er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'uniclaw'-kommandoen.",
  ...
  "desktop.cli.error.sidecarMissing": "UniClaw CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
