export const dict = {
  ...
  "desktop.menu.help.documentation": "UniClaw Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of UniClaw",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of UniClaw has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.installed.message": "CLI installed to {{path}}\n\nRestart your terminal to use the 'uniclaw' command.",
  ...
  "desktop.cli.error.sidecarMissing": "UniClaw CLI binary is missing. Try reinstalling the desktop app.",
