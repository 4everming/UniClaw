export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji UniClaw",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} UniClaw. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'uniclaw'.",
  ...
  "desktop.menu.help.documentation": "Dokumentacja UniClaw",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego UniClaw CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
