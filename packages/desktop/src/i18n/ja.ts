export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの UniClaw を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "UniClaw のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'uniclaw' コマンドを使用してください。",
  ...
  "desktop.menu.help.documentation": "UniClaw ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "UniClaw CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
