export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von UniClaw",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von UniClaw wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.installed.message":
    "CLI wurde in {{path}} installiert\n\nStarten Sie Ihr Terminal neu, um den Befehl 'uniclaw' zu verwenden.",
  ...
  "desktop.menu.help.documentation": "UniClaw-Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das UniClaw CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
