export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av UniClaw",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av UniClaw er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.menu.help.documentation": "UniClaw Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "UniClaw CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
