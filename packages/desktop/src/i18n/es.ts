export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de UniClaw",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de UniClaw. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de UniClaw",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de UniClaw. Intenta reinstalar la aplicación de escritorio.",
